...
/// Lists past successful solves with staggered entrance animations.
  ...
  Future<void> _confirmClear() async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('This removes every saved success from this device.'),
        actions: [
          TextButton(
                      ...
                      TweenAnimationBuilder<double>(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Finish a puzzle to build your success timeline. '
                              'Times, difficulty, and stats are saved here.',
