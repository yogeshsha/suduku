...
class _SudokuHomePageState extends State<SudokuHomePage> with RouteAware {
  ...
  /// notice can't interrupt an active game. Built once so the throttle in
  /// [Upgrader.durationUntilAlertAgain] survives rebuilds, not just app
  /// resumes.
  final Upgrader _upgrader = Upgrader(
    messages: CubbyUpdateMessages(),
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsets.only(
                                  right: d == GameDifficulty.values.last
                                      ? 0
                                      : 8,
                                ),
                                child: Tooltip(
                  ...
                  child: PressableScale(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        Navigator.of(
                          context,
                        ).push<void>(SudokuHistoryPage.route());
                      },
